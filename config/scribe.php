...
return [
    ...
    'description' => 'API documentation for Grapadi Strategix — business planning, forecast, management financial, consultation, affiliate, and payment gateway (SingaPay, Faspay) integrations.',
    ...
    'auth' => [
        ...
        'extra_info' => 'Login via <code>POST /api/auth/login</code> untuk mendapatkan Sanctum token, kemudian kirim sebagai header <code>Authorization: Bearer {token}</code>.',
    ],
